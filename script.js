...
function renderAccountModal(tab) {
    ...
    modal.innerHTML =
        ...
        '<div class="acc-body">' +
            ...
            (tab === 'signup' ? '<div class="form-group"><label class="form-label">Phone (optional)</label><input type="tel" id="acc-phone" class="form-input" placeholder="01xxxxxxxxx"></div>' : '') +
            '<div class="form-error" id="acc-error">' + (tab === 'signup' ? 'Please enter your name and email.' : 'Please enter your email to continue.') + '</div>' +
...
function accountSignup() {
    ...
    if (!name || !email) { document.getElementById('acc-error').classList.add('show'); return; }
